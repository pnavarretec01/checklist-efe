...
const { items, fetchItems, createItem, updateItem, apiDeleteItem } = useItemsApi();
...
<template>
  <div>
    ...
    <VDataTable :headers="headers" :items="items" :items-per-page="options.itemsPerPage" :page="options.page"
